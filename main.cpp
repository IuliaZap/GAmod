...
const float coeff_buf1[] =   { //для коэффициентов фильтра лучше использовать простой массив, т.к. скорость доступа к n-му элементу гораздо медленнее чем через простой массив
...
float value_out1 = 0;
int n_fir = (sizeof(coeff_buf1)/sizeof(*coeff_buf1));  //порядок фильтра
QVector<float> delay_line(n_fir);



// параметры фильтра2 6500Гц
const float coeff_buf2[] = {
